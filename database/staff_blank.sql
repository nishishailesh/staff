...
CREATE TABLE `staff` (
  ...
  `epassword` varchar(400) NOT NULL,
  `expirydate` date NOT NULL,
  `fullname` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `dob` date DEFAULT NULL,
  `present_residential_address` varchar(1000) NOT NULL,
  `permanent_residential_address` varchar(1000) NOT NULL,
...
CREATE TABLE `staff_movement_attachment` (
  ...
  CONSTRAINT `staff_movement_attachment_ibfk_2` FOREIGN KEY (`movement_id`) REFERENCES `staff_movement` (`movement_id`) ON UPDATE CASCADE
...
-- Dump completed on 2021-03-02 23:21:42
